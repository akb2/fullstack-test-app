...
- Create Angular project with ng: `ng new fullstacktestapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fullstacktestapp.client.esproj`).
